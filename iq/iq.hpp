...
namespace TOKEN_NAME {
   ...
   *  @brief Defines the currency contract example
   ...
   */
   ...
   struct account {
      ...
      */
      account( iq_tokens b = iq_tokens() ):balance(b){}
   ...
   **/
   static_assert( sizeof(account) == sizeof(uint64_t)+sizeof(iq_tokens), "unexpected packing" );
